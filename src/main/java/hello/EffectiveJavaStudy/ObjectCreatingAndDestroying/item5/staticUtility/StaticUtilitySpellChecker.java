package hello.EffectiveJavaStudy.ObjectCreatingAndDestroying.item5.staticUtility;

import hello.EffectiveJavaStudy.ObjectCreatingAndDestroying.item5.EnglishLexicon;
